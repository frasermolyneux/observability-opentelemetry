...
namespace MX.Observability.OpenTelemetry.WorkerService;

/// <summary>Worker Service / Azure Functions (isolated) registration entry point for MX Observability.</summary>
