# AGENTS.md — observability-opentelemetry

Repository `observability-opentelemetry` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
